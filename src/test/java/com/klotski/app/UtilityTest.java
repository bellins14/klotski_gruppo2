...
class UtilityTest {
    ...
    void isNotOverlapping() {
        ...
        assertTrue(Utility.isNotOverlapping(currentPieces[9], game.getConfiguration(), 100, 100));

        //Controlla che si sovrappongano
        assertFalse(Utility.isNotOverlapping(currentPieces[9], game.getConfiguration(), 100, 0));
    }
}